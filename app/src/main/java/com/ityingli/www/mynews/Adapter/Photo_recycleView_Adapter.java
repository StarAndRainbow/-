...
public class Photo_recycleView_Adapter  extends RecyclerView.Adapter<Photo_recycleView_Adapter.myholder> implements View.OnClickListener {
    ...
    public Photo_recycleView_Adapter(List<String> imgs_url, Context mcontext){
        ...
        Glide.with(mcontext).load(imgurl.get(position)).asBitmap().into(new SimpleTarget<Bitmap>() {
            ...
            public void onResourceReady(Bitmap bitmap, GlideAnimation<? super Bitmap> glideAnimation) {
               ...
               * */
                ...
                Log.e(TAG, "onBindViewHolder:图片的宽和高 " + bitmap.getWidth()+"--"+bitmap.getHeight());
